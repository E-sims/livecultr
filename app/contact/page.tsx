        ...
        >
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="block w-full rounded-md border-0 bg-white/5 py-2 px-3.5 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-sand sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div>
            ...
            <div className="mt-8 flex justify-end">
              <button
                type="submit"
                className="rounded-md bg-sand px-3.5 py-2.5 text-center text-sm font-semibold text-slate-100 shadow-sm hover:bg-sand/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sand"
              >
                Send message
              </button>
            </div>
